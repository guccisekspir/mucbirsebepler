                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        RaisedButton(
                                          ...
                                          child: Text("Satın Al "+_products[0].price+" ₺",style: GoogleFonts.bangers(fontSize: 26),),
                                        )
                                      ],
                                    ),
                                  ),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        RaisedButton(
                                          ...
                                          child: Text("Satın Al "+_products[3].price+" ₺",style: GoogleFonts.bangers(fontSize: 26),),
                                        )
                                      ],
                                    ),
                                  ),
